...
if __name__ == "__main__":
   ...
   # This program takes an initial number and modifies it through a series of operations.
...
if __name__ == "__main__":
    # You can change the starting numbers here to see how the result changes.
    starting_values = [15, 20, 25, 30, 35, 40, 45, 50, 55, 60]
    
    for value in starting_values:
        final_result = number_changer(value)
        print("\n---")
        print(f"The final number for {value} is: {final_result}")
        print("---")
